...
class BookList{
  constructor(){
    this.allBooks = []                              // lista com os livros
    this.nBooksRead = 0                             // número de livros lidos
    this.nBooksNotRead = 0                          // número de livros não lidos
    this.nextBook = null                            // próximo livro a ser lido
    this.nowBook = null                             // livro que está sendo lido no momento
    this.lastBook = null                            // último livro lido
  }   
      
  addBook (book){                                 // adiciona um livro na lista
  ...
  startCurrentBook(){                 // Seleciona o livro que começará a ser lido
